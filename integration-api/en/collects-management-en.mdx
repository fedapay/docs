  ...
  <Step title="Sending the Payout">
    ...
    * Schedule the payout for later.
    ...
    <Info>
      ...
      Use PHP, Node.js or Ruby code to send the repository, replacing **YOUR_SECRETE_API_KEY** with your private key.
    </Info>
  </Step>
...
Currently, [the available payout methods](/payment-methods/fr/payment-methods-fr) for sending funds to different countries in West Africa are supported

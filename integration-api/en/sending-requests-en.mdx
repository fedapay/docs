...
<Warning>
The MOOV, MTN, and MTN CI test servers have been removed. The momo_test mode is now the only supported method on the FedaPay sandbox. This ensures continued compatibility, without operator updates impacting your tests.
</Warning>

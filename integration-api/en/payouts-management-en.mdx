...
The merchant_reference field allows you to assign each payout operation (transfer of money from your FedaPay merchant account to a Mobile Money number or a bank account) a unique identifier defined by you.This identifier is stored by FedaPay and can later be used to easily retrieve or track a payout through a dedicated API.

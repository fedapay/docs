...
<Tip>**Security tip**: Enable 2FA to receive a confirmation code by SMS or via an app (such as Google Authenticator).
</Tip>
...
<Note>**Good to know**: In case of a suspicious attempt, immediately change your password and activate 2FA if not already enabled.
</Note>

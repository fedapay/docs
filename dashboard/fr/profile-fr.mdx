...
<Tip>**Astuce sécurité** : Activez 2FA pour recevoir un code de confirmation par SMS ou via une application (comme Google Authenticator).
</Tip>
...
<Note>**Bon à savoir** : En cas de tentative suspecte, changez immédiatement votre mot de passe et activez la 2FA si ce n’est pas encore fait.
</Note>

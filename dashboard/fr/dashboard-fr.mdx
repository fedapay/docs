...
3. **Gestion des Balances Multidevises**
...
4. **Suivi des Demandes de Paiement**
...
**Image** : Tableau de suivi des demandes de paiement avec des filtres pour le statut et les informations de paiement

...
![Image : Boutons de modification et suppression de client](https://res.cloudinary.com/dvilp6td2/image/upload/v1731331901/Customer_edit_-delete_buttons_m7hxha.png)


**Consulter l’historique des collectes** d’un client : suivez les collectes et les événements liés à chaque client.

 ![Image : Historique des collectes des clients](https://res.cloudinary.com/dvilp6td2/image/upload/v1731331901/Customer_collection_history_twedc7.png)

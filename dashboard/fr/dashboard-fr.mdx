...
1. Depuis le tableau de bord de votre compte FedaPay, rendez-vous dans l'onglet : **Paramètres d'entreprise**.
...
Dans cette section, vous trouverez deux onglets : **'Utilisateurs'** et **'Invitations en attente'**.
    ...
    ![une image montrant l'accès aux paramètres business](https://res.cloudinary.com/dvilp6td2/image/upload/v1731370484/team-page-dashboard_kk1xcd.png)
  </Step>

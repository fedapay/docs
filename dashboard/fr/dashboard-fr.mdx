...
3. Vous aurez les options suivantes pour les dépôts sélectionnés :
...
3. Cliquez sur M'envoyer le code de vérification.
4. Renseignez le code de vérification reçu par SMS dans l'espace dédié et cliquez sur Vérifier.
...
Pour configurer vos préférences, accédez à **Paramètres d'entreprise** dans le tableau de bord. Vous verrez une interface avec cinq onglets principaux qui permettent de personnaliser différents aspects de votre compte : **Méthodes de Paiement**, **Frais**, **Devises**, **Notifications** et **Page de Paiement**.

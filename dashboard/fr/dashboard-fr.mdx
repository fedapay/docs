...
![Image : Page des collectes du tableau de bord](https://res.cloudinary.com/dvilp6td2/image/upload/v1731333049/Dashboard_collections_page_cbflgy.png)
...
![Image : Formulaire de création de page de paiement](https://res.cloudinary.com/dvilp6td2/image/upload/v1731333724/Payment-page-creation_form_t7zilg.png)
...
_**[(image illustrant le formulaire de comptes mobile money)
]**_
...
_**![(image montrant les différentes étapes de vérification)
]**_
...
">
    ...
    _**![(Insérer une image montrant l'accès aux paramètres business)]**_
  ...
  <Step title="Ajouter un utilisateur">
    ...
    _**![(Insérer une image montrant la page Équipe dans le dashboard)]**_
  ...
  <Step title="Attribution des rôles">
    ...
    _**![(Insérer une image montrant les différentes catégories d'utilisateurs)]**_
  ...
  <Step title="Inviter un collaborateur">
    ...
    _**![(Insérer une image montrant l'invitation d'un utilisateur)]**_
  </Step>
  <Step title="Suivi des invitations">
     ...
     _**![(Insérer une image montrant la page d'invitation avec les collaborateurs en instance)]**_
...
Toutes les transactions marquées comme _"Transférée"_ sont disponibles sur la balance de votre compte marchand. Une transaction approuvée nécessite 72 heures avant d’être transférée sur votre balance. Pour accéder aux fonds sur cette balance, suivez les étapes suivantes :

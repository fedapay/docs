...
Sur FedaPay, toutes les transactions marquées comme **"transférées"** sont disponibles sur votre balance FedaPay en fonction de la méthode de paiement utilisée (Mobile Money, carte bancaire, etc.).
Pour retirer vos fonds, vous devez d'abord ajouter un compte bancaire ou un numéro Mobile Money.

...
<Warning>La fonctionnalité Payout vous permet d’effectuer des dépôts (versements) directement vers des comptes Mobile Money depuis votre solde FedaPay.

**Comment activer Payout ?**

Pour activer cette fonctionnalité, vous devez envoyer une demande par email à support@fedapay.com
...
**⚠️ Bonnes pratiques :**
   ...
   * Tenez compte des plafonds journaliers fixés par les opérateurs Mobile Money pour éviter tout rejet.</Warning>

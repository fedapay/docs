...
<Note>
_**Retrouvez plus d'informations dans [le dépôt GitHub React.js SDK de FedaPay](https://github.com/FedaPay/fedapay-reactjs).**_
...
_**Exemple d'inclusion dans public/index.html :**_

...
description: 'Que vous désirez recevoir de l’argent d’un client (Feda Direct) ou encore intégrer FedaPay dans votre application web ou mobile (Feda Commerce), accepter un paiement est un processus qui se décline en 3 étapes.
'
icon: "house"
iconType: "solid"
---

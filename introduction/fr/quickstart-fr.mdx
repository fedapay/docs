...
FedaPay vous offre une solution simple et rapide pour gérer les paiements en ligne. Que vous soyez un entrepreneur, une ONG, ou un travailleur indépendant, FedaPay facilite la collecte des paiements tout en assurant la sécurité de vos transactions. Suivez ce guide pour créer et activer votre compte, découvrir les cas d’usage de FedaPay, et renforcer la sécurité de votre compte.
  ...
  ### Créer un compte FedaPay (Test ou Live)
    ...
    <Steps>
      ...
      <Step title="Mode Test">
        ...
        ![Formulaire d'inscription ou de connexion sandbox](https://res.cloudinary.com/dvilp6td2/image/upload/v1730990095/img_form_sandbox-compte_d3hcba.png)
      </Step>
    </Steps>
  ...
  <Step title="Soumettre votre compte pour validation ">
    ...
    ![Activation de compte](https://res.cloudinary.com/dvilp6td2/image/upload/v1730990095/img_active_live-compte_yzrhb7.png)
  </Step>
  <Step title="Remplissez le formulaire">
    ...
    **Documents de vérification (KYC)** 
    ...
    ![Formulaire de validation de compte live](https://res.cloudinary.com/dvilp6td2/image/upload/v1730990095/img_form_valide_live-compte_dyajb3.png)
  </Step>

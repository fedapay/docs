...
<Steps>
  ...
  <Step title="Créer une collecte">
    Une transaction représente le montant que vous attendez du client. Renseignez le montant de la collecte, ajoutez une description (obligatoire) et, si besoin, personnalisez le lien de retour après paiement.
  </Step>

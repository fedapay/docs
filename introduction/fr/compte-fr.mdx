...
<Warning>
**Attention :** Le montant total réparti doit être inférieur au montant de la transaction moins les commissions de FedaPay, sinon la transaction échouera.</Warning>

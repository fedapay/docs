...
FedaPay payouts allow users to transfer funds directly to Mobile Money accounts, providing easy access to cash, especially useful for users in Africa where Mobile Money is widespread.

<Note>Currently, payouts are only possible for Mobile Money accounts, allowing users to easily receive funds collected via FedaPay on their mobile phone.</Note>

...
Great news: TAP & GO is available directly from your FedaPay dashboard. You can activate the feature with no need to install a new app. You’ll then be able to accept payments via QR code  or USSD, and request a display kit if needed.

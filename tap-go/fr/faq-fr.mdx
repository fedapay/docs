...
Oui. Comme pour toutes les transactions traitées via FedaPay, une commission standard de 1,8 % est prélevée automatiquement sur chaque paiement reçu via Mobile Money (MTN Benin et Moov Benin).

...
1. **Choose Your Environment**: Use the [sandbox](https://sandbox.fedapay.com/register) for testing and [live](https://live.fedapay.com/register) mode for production.
...
Dive into the [Customer Section](https://fedapay.mintlify.app/api-reference/customers/) to begin setting up your first payment flow!
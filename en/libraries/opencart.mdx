...
<Steps>
  <Step title="Download and Install the Plugin">
    Download the FedaPay plugin for OpenCart by clicking [here](https://plugins-fedapay.yaburu.shop/plugin-fedapay-pour-opencart-1764584742).
    ...
    **Installation Steps :**
    ...
    2. Click on **Extensions** > **Install**. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731419529/extension_opencart_egb2iy.png" alt="Image Showing the Extensions menu" />
    ...
    7. Click the green button to install FedaPay. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731419528/active-fedapay_opencart_fynw66.png" alt="Image Showing the install button" />
  </Step>
  ...
  <Step title=" Configure the FedaPay Plugin">
    ...
    3. Choose the environment according to your needs :
       ...
       * **Live** to start accepting real payments with your FedaPay account. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731420712/selection-environement_opencart_yuffpa.png" alt="Image Showing environment selection" />
  ...
  <Step title="Add and Configure the FCFA Currency">
    ...
    **Steps to add FCFA :**
    ...
    1. Click on **System** > **Localization** > **Currencies**. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731421730/devise_opencart_qlqgoo.png" alt="Image: Showing the path to currencies" />

    2. Click the blue Add a currency button. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731421731/ajouter-devise_opencart_twnopw.png" alt="Image Showing how to add a new currency" />

    3. Fill in the information for **FCFA** (name, symbol, conversion rate) and save. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731421729/sauvegarder-devise_opencart_vcgq7o.png" alt="Image Showing the information to fill for FCFA" />

...
* Add a custom label or `custom_metadata` to each transaction (e.g. user ID, order ID).

* Secure your setup with a clear API key management policy (never expose keys in frontend code).
</Warning>

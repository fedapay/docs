...
<Steps>
  <Step title="Download and Install the Plugin">
    You can download the FedaPay plugin for PrestaShop by clicking [here](https://plugins-fedapay.yaburu.shop/plugin-fedapay-pour-prestashop-1764584595).
    ...
    **Installation Steps :**
    ...
    2. Click on **Modules > Module Manager**. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731415087/module_prestshop_pnsvri.png" alt="prestashop mode" />
    ...
    4. Upload the plugin file you downloaded. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731415086/televerser_module_prestashop_dz1zv9.png" alt="Image Showing where to upload the plugin" />
  ...
  <Step title="Configure the FedaPay Plugin">
    ...
    * Paste this key into the corresponding field in PrestaShop. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731416101/config_prestashop_sandbox_uaexbx.png" alt="Image showing sandbox configuration" />
    ...
    * Paste this key into the corresponding field in **PrestaShop**. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731416102/config_prestashop_live_wpj2k1.png" alt="Image showing live configuration" />
  </Step>
  ...
  <Step title="Configure the Currency (FCFA)">
    ...
    **Steps to add FCFA :**
    ...
    1. Go to **International** > **Localization**. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731415087/module_prestshop_pnsvri.png" alt="Image Showing access to localization" />
    ...
    3. Click on **Add a currency**. <img src="https://res.cloudinary.com/dvilp6td2/image/upload/v1731417650/ajout-devise_prestashop_yqzlmc.png" alt="Image Showing how to add a currency" />

...
To configure FedaPay, go to your WordPress dashboard and click on:
  ...
  <Step title="Retrieve and Enter Your API Keys">
    ...
    3. Find the API keys for your **Sandbox (test)** and **Live (production)** accounts.
       ...
       * The **live** mode private key starts with **sk_live**.

       * The **sandbox (test)** private key starts with **sk_sandbox**.

    4. Copy these keys and paste them into the corresponding fields in the WooCommerce settings.

    ![Image montrant les clés API](https://res.cloudinary.com/dvilp6td2/image/upload/v1731408081/cle-woocommerce-fedapay_nwyzog.png)
  </Step>
  ...
  <Step title="Passerelle de paiement prête">
    ...
    ![Image montrant la passerelle de paiement active dans WooCommerce](https://res.cloudinary.com/dvilp6td2/image/upload/v1731408081/passerelle-activer_ekwa2d.png)
  </Step>
</Steps>

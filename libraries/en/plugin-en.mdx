...
<Steps>
  ...
  <Step title="Configure the FedaPay Plugin">
    ...
    * Go to the **API** menu and copy the test secret key (**sk_sandbox**).

    * Paste this key into the corresponding field in PrestaShop.

      ![Image Showing where to paste the sandbox key](https://res.cloudinary.com/dvilp6td2/image/upload/v1731416101/config_prestashop_sandbox_uaexbx.png)

    **Live Mode :**

    * Log in to your FedaPay **Live account**.

    * Go to the **API** menu and copy the live secret key (**sk_live**).

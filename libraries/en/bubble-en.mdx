...
<Note>**Tip**: Once installed, you will see the plugin in the **Installed plugins** list.</Note>  
...
Even if it can be invisible to your users, this element allows Bubble to trigger the payment window. **Do not delete it**.</Info>  
...
<Tip>**Advice**: You can use your user form fields to automatically fill in this data.</Tip>  

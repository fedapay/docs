  ...
  <Step title="Télécharger et installer le plugin">
    ...
    **Étapes d'installation :**
    ...
    6. Trouvez **FedaPay** dans la liste des moyens de paiement.
      ...
      ![Image montrant le filtre et la liste des moyens de paiement](https://res.cloudinary.com/dvilp6td2/image/upload/v1731419924/filter-extension_opencart_ad1srr.png)

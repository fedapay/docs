...
<Steps>
  ...
  <Note>
      [Cliquez ici pour tester](https://checkout-button-demo.surge.sh/checkout/payment-button.html)
    </Note>
  </Step>
  ...
  <Note>
      [Cliquez ici pour tester](https://checkout-button-demo.surge.sh/checkout/customize-form.html)
  </Note>
  </Step>
  ...
  <Step title="Ajouter plusieurs boutons de paiement sur une même page">
   ...
   <Note>
      [Cliquez ici pour tester](https://checkout-button-demo.surge.sh/checkout/add-multiple-buttons.html)
    </Note>
  </Step>
  ...
  <Note>
      [Cliquez ici pour tester](https://checkout-button-demo.surge.sh/checkout/trigger-collection.html)
  </Note>
  </Step>
  ...
  <Note>
      [Cliquez ici pour tester](https://checkout-button-demo.surge.sh/checkout/payment-no-redirection.html)
  </Note>
  </Step>
</Steps>

...
| -------- | ------------------------------------- | -------- | --------             |
| Name     | Full name of user                     | Name     | Full name of user    |
| Age      | Reported age                          | Age      | Reported age         |
| Joined   | Whether the user joined the community | Joined   | Whether the user joty|
